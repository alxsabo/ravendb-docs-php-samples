...
class AtomicGuards
{
    public function testCreateAtomicGuard(): void
    {
        //var (nodes, leader) = await CreateRaftCluster(3);
            ...
            // REEB NOTE: AsyncSession and ASYNC methods not supported in PHP, if there is an interface to some Async method, then it falls back to sync method
            // I think we should probably not include this in documentation, but we need to check.
