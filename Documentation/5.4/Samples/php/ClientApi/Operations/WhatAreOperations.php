...
class WhatAreOperations
{
    public function examples(): void
    {
        ...
        try {
            ...
            // REEB NOTE: kill not implemented in PHP (also not displayed in Python documentation, but there is a link on page)
            ...
            $operation = $documentStore->operations()->send($deleteByQueryOp);
...
// REEB NOTE: Cancellation Token is not implemented in PHP
