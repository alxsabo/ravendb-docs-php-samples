...
class ExplorationQueries
{
    public function explorationQueries(): void
    {
        ...
        try {
            ...
            // REEB NOTE: next 3 examples are like in NodeJS,
            // because I can't create it in the same way as it is done in C#
            // or maybe I just don't know how to do it at the moment :)))

            // ignore section exploration-queries_3.2
