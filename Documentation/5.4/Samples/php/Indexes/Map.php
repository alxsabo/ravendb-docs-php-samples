...
// REEB NOTE: region indexes are like they where in the moment of creating in 5.4 - map.cs file
// we figured out that they were wrong, so it should be fixed here also
...
// @REED NOTE: This region identifiers should be changed, also next two regions are missing from other documentation
#region indexes_1_6
...
class Companies_ByAddress_Country extends AbstractIndexCreationTask
{
    public function __construct()
    {
        $this->map = "";
...
class Companies_ByAddress_Latitude  extends AbstractIndexCreationTask
{
    public function __construct()
    {
        parent::__construct();
