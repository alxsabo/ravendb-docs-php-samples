...
interface IFoo
{
    ...
    // REEB note: include this explanation somewhere:

    // get("CounterName")  returns single int value for that counter
    //
    // get(["counter1", "counter2"] will return array with values for all passed counters
    // for example: [ "counter1" => 1, "counter2" => 5 ]
...
class Counters
{
    public function examples(): void
    {
        ...
        try {
            ...
            // REEB note: following is not implemented because we don't have in java and python
...
//                foreach ($counterValue in queryResults)
//                {
